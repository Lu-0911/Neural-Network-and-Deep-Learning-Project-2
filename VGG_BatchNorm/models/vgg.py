...
class VGG_BatchNorm(nn.Module):
    """
    VGG_BatchNorm model
    Exactly matches the architecture of VGG-A but inserts BatchNorm layers 
    before each activation layer to stabilize training distributions.
    """
    def __init__(self, inp_ch=3, num_classes=10, init_weights=True):
        super().__init__()
...
if __name__ == '__main__':
    ...
    print(get_number_of_parameters(VGG_BatchNorm()))